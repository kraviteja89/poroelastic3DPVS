function exchangePercent = pvs_exchange_percentage(pathName, caseName, reps, sasThresh)
...
exchangePercent = zeros(nFrames, 3);
for n = 1:nFrames
    ...
    exchangePercent(n, :) = 100*particleFractions;
end